...
awful.key({modkey}, 'r', function() _G.awesome.spawn(apps.default.rofi) end,   -- rofi
...
awful.key({ }, "Print", function () awful.util.spawn("scrot 'Screenshot-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end,
 ...
 awful.key({modkey, "Shift"  }, "Print", function() awful.util.spawn("xfce4-screenshooter") end,
          {description = "xfce4 screenshot", group = "screenshots"}),
...
awful.key({modkey}, 'w', function() awful.util.spawn('firefox') end, --firefox
          {description = 'open a browser', group = 'launcher'}),
awful.key({modkey, 'Shift'}, 'Return' , function() awful.util.spawn('pcmanfm') end, --pcmanfm
          {description = 'open a file manager', group = 'launcher'}),
awful.key({modkey, 'Shift'}, 's' , function() awful.util.spawn('simplescreenrecorder') end, --pcmanfm
          {description = 'open the recorder', group = 'launcher'}),

awful.key({modkey, 'Shift'}, 'w' , function() awful.util.spawn('gnome-multiwriter') end, --gnome multiwriter 
          {description = 'open gnome multiwriter', group = 'launcher'}),
awful.key({modkey, 'Shift'}, 'x' , function() awful.util.spawn('gnome-disks') end, --gnome disks
          {description = 'open gnome disks', group = 'launcher'}),
awful.key({modkey, 'Shift'}, 'v' , function() awful.util.spawn('virtualbox') end, --virtualbox
          {description = 'open virtualbox', group = 'launcher'}),
awful.key({modkey, 'Shift'}, 'n' , function() awful.util.spawn('nitrogen') end, --nitrogen
          {description = 'open nitrogen', group = 'launcher'}),
awful.key({modkey}, 'v' , function() awful.util.spawn('code') end, --vscode
          {description = 'open vscode', group = 'launcher'}),
awful.key({modkey}, 'c' , function() awful.util.spawn('google-chrome-stable') end, --chrome
          {description = 'open chrome', group = 'launcher'}),          
awful.key({modkey}, 'Return',
          function() awful.util.spawn_with_shell(apps.default.terminal) end, --terminal
          {description = 'open a terminal', group = 'launcher'}),
awful.key({modkey, 'Control'}, 'r', _G.awesome.restart, --reload awesome
...
awful.key({modkey, 'Shift'}, 'k', function() _G.toggle_quake() end,
